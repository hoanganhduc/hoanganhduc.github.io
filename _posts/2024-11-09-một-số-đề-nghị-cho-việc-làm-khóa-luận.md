...
* Có file `README` mô tả cách cài đặt, cách chạy, dữ liệu đầu vào và kết quả đầu ra.
...
* Trang quy chế, biểu mẫu đào tạo bậc đại học của HUS, ví dụ [trang này](https://geology.hus.vnu.edu.vn/quy-che-bieu-mau-dao-tao-bac-dai-hoc/). Sinh viên vẫn cần kiểm tra trang chính thức/thông báo mới nhất của khoa hoặc bộ môn mình.
