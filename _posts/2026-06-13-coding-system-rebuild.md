...
- *Example — pre-submission review.* A **manuscript-review** panel (Correctness, Exposition, Literature) reads a draft and produces an annotated PDF with per-section comments, separating "this is wrong" from "this is unclear" (the [paper-review](https://github.com/hoanganhduc/ai-agents-skills/tree/main/canonical/skills/paper-review) skill plus the same [agent-group-discuss](https://github.com/hoanganhduc/ai-agents-skills/tree/main/canonical/skills/agent-group-discuss) panels).
