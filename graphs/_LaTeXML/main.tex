...
\begin{itemize}
	...
	\item For each graph $H$, if $H = \mathsf{TS}(G)$ is nonplanar for some graph $G$, we provide data on a \href{https://en.wikipedia.org/wiki/Kuratowski\%27s_theorem}{Kuratowski subgraph} of $H$, \textit{not} the whole graph $H$.
