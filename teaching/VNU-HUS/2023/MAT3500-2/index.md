...
| Các phương pháp đếm II | [slides]({{ page.url | remove: "-2" | append: "Lectures/" | append: "Counting_II.pdf" }}) | Chương 6, 6.3--6.5 (Rosen) |
| Lý thuyết đồ thị I | [slides]({{ page.url | remove: "-2" | append: "Lectures/" | append: "Graphs_I.pdf" }}) | Chương 10, 10.1--10.3 (Rosen) |
