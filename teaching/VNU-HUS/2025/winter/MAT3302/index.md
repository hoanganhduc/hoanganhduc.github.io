...
| **Danh sách bài tập**| [Tuần 1]({{ page.url | append: "ps1.pdf" }}) <br> [Tuần 2]({{ page.url | append: "ps2.pdf" }}) <br> [Tuần 3]({{ page.url | append: "ps3.pdf" }}) <br> [Tuần 4]({{ page.url | append: "ps4.pdf" }}) <br> [Tuần 5]({{ page.url | append: "ps5.pdf" }}) <br> [Tuần 6]({{ page.url | append: "ps6.pdf" }}) <br> [Tuần 7]({{ page.url | append: "ps7.pdf" }}) |
